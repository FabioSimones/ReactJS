  ...
  return (
    <div className='review-form'>
        ...
        <div className="form-control">
          ...
          <textarea name="comment" id="comment" placeholder='Conte-nos como foi sua experiência quanto a sua aquisição de produto...'value={data.comment || ""} onChange={(e) => updateFieldHandler("comment", e.target.value)}></textarea>
        </div>
    </div>
